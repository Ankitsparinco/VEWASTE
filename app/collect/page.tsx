...
import { getWasteCollectionTasks, updateTaskStatus, saveReward, saveCollectedWaste, getUserByEmail } from "@/utills/db/actions"
    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
      ...
      <div className="mb-4 flex items-center">
        <Input
          ...
          className="mr-2  px-4 py-2 border border-gray-300 rounded-lg text-black focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white transition-all duration-300"
        />
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            {verificationStatus === 'success' && verificationResult && (
              <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-md text-black">
            ...
            <Button onClick={() => setSelectedTask(null)} variant="outline" className="w-full mt-2 ring-2 ring-green-500 ring-offset-2 focus:outline-none focus:ring-4 focus:ring-green-700">
              Close
            </Button>
          </div>
        </div>
