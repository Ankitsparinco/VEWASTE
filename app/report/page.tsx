...
import { createUser, getUserByEmail, createReport, getRecentReports } from "@/utills/db/actions";
import { useRouter } from 'next/navigation';
import { toast } from 'react-hot-toast'

const geminiApiKey = "AIzaSyCaGf0I37zp8dv8asHJvj3uB0MEcMHEPcI";
const googleMapsApiKey = "AIzaSyBB4jXnRXQSYtsEWhDTfFxVThIkH8qVjQg";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            ...
            {isLoaded ? (
              ...
              >
               <input
                 ...
                 required
                 className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-300 text-black bg-white"
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange}
              required
              className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-300 bg-gray-100 text-black"
